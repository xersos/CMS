...
@NgModule({
  ...
  declarations: [DashboardComponent, SitesComponent, AddUpdateSiteComponent, PagesComponent, PagesTreeComponent, PagesTreeBranchComponent, AddUpdatePageComponent]
})
